...
const CryptoDetailPage = () => {
  ...
  //hook z cache listy krypto bez osobnego requesta http, o ile dane w tanquery sa swieze
  //optymalizacja liczby requestow
  //nieoptymalne gdy wpiszemy link bezposrednio w przegladarce
  //nie obsluguje krypto spoza listy
  ...
  //wyswietlanie tylko jednej monety
